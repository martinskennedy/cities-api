package com.github.kennedy.cities.service;
...
import com.github.kennedy.cities.entities.City;
import com.github.kennedy.cities.repositories.CityRepository;
...
public class DistanceService {
     ...
     * @return
     */
    public Double distanceByPointsInMiles(final Long city1,
                                          final Long city2) {
     ...
     * @return
     */
    public Double distanceUsingPoints(final Long city1,
                                      final Long city2,
                                      final EarthRadius unit) {
     ...
     * @return
     */
    public Double distanceByCubeInMeters(Long city1,
                                         Long city2) {
    ...
    private double doCalculation(final double lat1,
                                 final double lon1,
                                 final double lat2,
                                 final double lng2,
